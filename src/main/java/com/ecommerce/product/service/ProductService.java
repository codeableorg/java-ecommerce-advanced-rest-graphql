...
public class ProductService {
  ...
  // Note: Top selling logic will be moved to Order service later
  ...
  // Métodos para filtrado y búsqueda simplificados
  public Flux<Product> searchProducts(String name, String category, Double minPrice, Double maxPrice,
    ...
    return productRepository.searchProducts(name, category, minPrice, maxPrice, size, offset);
  }

  public Mono<Long> countSearchProducts(String name, String category, Double minPrice, Double maxPrice) {
    return productRepository.countSearchProducts(name, category, minPrice, maxPrice);
  }
}
